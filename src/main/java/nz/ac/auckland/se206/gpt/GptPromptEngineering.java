...
public class GptPromptEngineering {
  ...
  public static String getBookRiddleHard(String book) {
    return "You are a wizard who is setting a test for his apprentice. You have 3 books, a book"
        ...
        + " up, do not give the answer. Otherwise, respond appropriately to the user as a wise"
        + " wizard would.";
  }
  ...
  public static String getBookRiddleEasy(String book) {
    return "You are a wizard who is setting a test for his apprentice. You have 3 books, a book"
        ...
        + " Otherwise, respond appropriately to the user as a wise wizard would.";
  }
  ...
  public static String getMediumResolved() {
    return "The user has successfully solved the riddle. Congratulate them in one line."
        + " Hints should only tell the user to either look around the rooms for ingredients from"
        + " the book for their potion or to check the book to make sure ingredients are brewed in"
